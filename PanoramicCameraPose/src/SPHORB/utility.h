...
void drawMatches(const cv::Mat& img1, const vector<KeyPoint>& keypoints1,
	const cv::Mat& img2, const vector<KeyPoint>& keypoints2,
	const vector<DMatch>& matches1to2, cv::Mat& outImg, const Scalar& matchColor, const Scalar& singlePointColor,
